...
<div class="col-md-8 offset-md-2">
  ...
  <div class="card card-info">
    ...
    <div class="card-header">
      <h3 class="card-title">{{ __('Warehouse') }}{{ __('Create') }}</h3>
    </div>

    {{-- form for store warehouse --}}
    <form action="{{ route('warehouse.store') }}" method="POST">
      ...
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <input type="text" class="form-control col-sm-6" name="name" placeholder="Warehouse Name" value="{{$warhouseCode}}" readonly>
        </div>
