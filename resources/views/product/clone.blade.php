...
<div class="col-md-10 offset-md-1">
  ...
  <div class="card card-info">
    ...
    <form action="{{ route('product.store.clone') }}" enctype="multipart/form-data" method="POST">
      @csrf
      ...
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <div class="date col-sm-6">
            <input type="date" class="form-control datetimepicker-input" name="mfd_date" placeholder="Manafacture Date" value="{{$product->mfd_date}}" />
          </div>
        </div>
        <div class="form-group row">
          <label class="col-sm-4 offset-sm-1 col-form-label">{{ __('Expired Date')}}</label>
          <div class="date col-sm-6">
            <input type="date" class="form-control datetimepicker-input" name="expire_date" placeholder="Expired Date" value="{{$product->expire_date}}" />
          </div>
        </div>
        <div class="offset-sm-5">
        @error('expire_date')
