...
class SaleCategoryExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    private $saleService;
    private $request;
    ...
    {
        $saleCategoryList = $this->saleService->getSaleCategoryListForExport($this->request);
